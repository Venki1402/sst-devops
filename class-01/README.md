...
- topics of Interest (IDK) - kubernetes, terraform
- DNS - domain name system
- load balancers - 2types - path based and Insance (load distribution)
- there are 2 types of asynchronous communication - subscriber model & message queue
